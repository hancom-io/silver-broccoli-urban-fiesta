...
이렇듯 **문서가 있는 어떠한 환경에도 쉽게 적용되어 기기나 OS에 구분되지 않고 브라우져 하나만으로 안전하고 편리한 문서의 보기 및 공유를 가능하게 해주는 솔루션**이 바로 한글과컴퓨터의 통합문서뷰어이다.

**한컴통합문서뷰어**에 대해 한마디로 정의하자면 ***다양한 형식의 문서를 원하는 파일 포맷으로 변환시키는 솔루션*** 이라 할 수 있다.
